...
function Navbar() {
  const [menulogo, setMenuLogo] = useState("menulogo unclicked");
  const [menu, setMenuClass] = useState("menu hideMenu");
  const [isMenuClicked, setIsMenuClicked] = useState(false);

  const updateMenu = () => {
    if (!isMenuClicked) {
      setMenuLogo("menulogo clicked");
      setMenuClass("menu showMenu");
    } else {
      setMenuLogo("menulogo unclicked");
      setMenuClass("menu hideMenu");
    }
    ...
    <div>
      <header>
        <nav className="w-full flex flex-row justify-between">
          ...
          <ul className="hidden lg:flex justify-start items-center w-1/4">
            <li className="text-white text-xl font-bold mr-5 px-4 py-2">
          ...
          <div className="hidden lg:flex items-center">
            <a href="https://twitter.com/BlaneWins" target="_blank">
              <FontAwesomeIcon
                icon={faTwitter}
                className="icon text-white text-3xl pr-4"
              ></FontAwesomeIcon>
            </a>
            <a
      ...
      <ul className={menu} onClick={updateMenu}>
        <li>
          <a href="#projects">Projects</a>
        </li>
        <li>
